...
/**
 * A {@link HttpResponseProvider} that supports http.http.android request with all properties. It supports any http.http.android header you define as
...
public class DefaultHttpResponseProvider extends AbstractHttpResponseProvider {
     ...
     * 
     * @param ignoreAdditionalHeaders In some cases you might want to ignore additional http.http.android headers and only want to check
     ...
     *            <code>true</code>. In case you specify <code>false</code> all http.http.android headers will be matched.
     */
