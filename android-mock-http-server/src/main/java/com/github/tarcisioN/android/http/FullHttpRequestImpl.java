...
public final class FullHttpRequestImpl implements FullHttpRequest {
     ...
     * @return This http.http.android request.
     */
     ...
     * @return The http.http.android request.
     */
    ...
    public String getUrl() {
        try {
            ...
            final URI uri =
                new URI("http.http.android", host, httpRequest.getPath(), queryParamsAsString.isEmpty() ? null : queryParamsAsString,
                    null);
