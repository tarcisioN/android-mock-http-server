...
import com.github.tarcisioN.android.http.client.ApacheHttpClientImpl;
import com.github.tarcisioN.android.http.client.HttpClient;
import com.github.tarcisioN.android.http.client.HttpClientResponse;
import com.github.tarcisioN.android.http.client.HttpRequestException;
...
public class LoggingHttpProxy {
    ...
    private static final String TAG = "LoggingHttpProxy";
    ...
    private class ProxyImplementation implements Container {
        ...
        public void handle(final Request request, final Response response) {
            ...
            try {
                ...
                Log.d(TAG, "Received request: " + httpRequest);
                ...
                if (forwardHttpRequest == null) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            Log.e(TAG, "IOException when trying to copy response of forward request.", e);
                        ...
                        Log.e(TAG, "HttpRequestException when forwarding request.", e);
    ...
    public void stop() throws IOException {
        Log.d(TAG, "Stopping and closing connection.");
        connection.close();
    }
}
