 ...
 * requests/responses or the {@link MockHttpServer} for running your code against mocked http.http.android requests/responses. </p> You
...
public class MockAndProxyFacade {
    ...
    private MockAndProxyFacade(final Builder builder) {
        ...
        if (Mode.MOCKING.equals(mode)) {
            ...
            proxy = new LoggingHttpProxy(builder.port, builder.requestBuilders);
        }
    }
