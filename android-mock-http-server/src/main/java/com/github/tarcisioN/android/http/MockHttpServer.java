...
/**
 * Mock Http Server which can be used to return upfront defined responses for a set of http.http.android requests.
 * <p/>
 * Mock http.http.android server will in its default configuration return code 598 in case it receives a request which was not foreseen.
 * In case of an internal exception it will return http.http.android returncode 599.
 * 
 * @author kristof
 */
    ...
    public class ExpectationHandler implements Container {
        ...
        public void handle(final Request req, final Response response) {
            ...
            try {
                ...
                Log.d(TAG, "Got request: " + receivedRequest);
                final HttpResponse expectedResponse = responseProvider.getResponse(receivedRequest);

                if (expectedResponse != null) {
                    Log.d(TAG, "Got response for request: " + expectedResponse);
                    ...
                    try {
                        ...
                        Log.e(TAG, "IOException when getting response content.", e);
                    }
                } else {
                    Log.e(TAG, "Did receive an unexpected request:" + receivedRequest);
                    ...
                    try {
                        ...
                        Log.e(TAG, "IOException when writing response content.", e);
                    }
                }
                ...
                try {
                    ...
                    Log.e(TAG, "IOException when writing response content.", e2);
                }
            }
        }
