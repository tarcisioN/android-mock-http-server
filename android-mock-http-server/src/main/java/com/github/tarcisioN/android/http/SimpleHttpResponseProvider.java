 ...
 * <li>Content-Type http.http.android header</li>
 * <li>Request Entity</li>
 * </ul>
 * It does not support other http.http.android headers than Content-Type. If other http.http.android header parameters are present in HttpRequest they
 * will be ignored.
 * 
 * @see MockHttpServer
 * @author kristof
