...
/**
 * Indicates there are {@link HttpRequest http.http.android requests} that we expected but did not get and/or that we got unexpected
 * {@link HttpRequest http.http.android requests}.
 * 
...
public class UnsatisfiedExpectationException extends Exception {
    ...
    /**
     * Gets the http.http.android requests that we expected but did not get.
     * 
     * @return Collection of http.http.android requests that we expected but did not get.
     */
    ...
    /**
     * Gets the http.http.android requests that we got but did not expect.
     * 
     * @return Collection of http.http.android requests that we got but did not expect.
     */
