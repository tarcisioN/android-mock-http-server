package com.github.tarcisioN.android.http.client;
...
public interface HttpClientResponse<T> {
    ...
    /**
     * Indicates if result of http.http.android request was successful. Response was successful in case there is no error message.
     * 
    ...
    /**
     * Gets response object as a result of executing http.http.android request.
     * 
     * @return the response Response as a result of executing http.http.android request.
     */
    T getResponseEntity();
