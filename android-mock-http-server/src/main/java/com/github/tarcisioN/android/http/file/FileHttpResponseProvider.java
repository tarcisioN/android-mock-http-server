...
import com.github.tarcisioN.android.http.AbstractHttpResponseProvider;
import com.github.tarcisioN.android.http.HttpRequest;
import com.github.tarcisioN.android.http.HttpResponseProvider;
import com.github.tarcisioN.android.http.LoggingHttpProxy;
 ...
 * <p>
 * It reads all http.http.android requests on construction and keeps them in memory. It does not keep responses in memory. They are read
...
public class FileHttpResponseProvider extends AbstractHttpResponseProvider {
    ...
    protected void lazyInitializeExpectedRequestsAndResponses() {
        ...
        if (!requestFile.exists()) {
            throw new IllegalStateException("No saved http.http.android request/responses found. File " + requestFile + " not found.");
        }
