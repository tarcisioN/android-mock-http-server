...
enum FileNameBuilder {
    ...
    /**
     * File name in which to store http.http.android request (except entity).
     */
    REQUEST_FILE_NAME("request"),
    /**
     * File name in which to store http.http.android request entity.
     */
    REQUEST_ENTITY_FILE_NAME("request_entity"),
    /**
     * File name in which to store http.http.android response.
     */
    RESPONSE_FILE_NAME("response"),
    /**
     * File name in which to store http.http.android response entity.
     */
