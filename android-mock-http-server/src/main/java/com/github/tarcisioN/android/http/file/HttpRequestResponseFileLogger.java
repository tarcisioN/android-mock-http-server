...
import com.github.tarcisioN.android.http.HttpRequestResponseLogger;
 ...
 * <ul>
 * <li>&lt;fileName&gt;_request_0000x.txt : Contains http.http.android method, headers, path and query parameters. Is readable (text
 ...
 * <li>&lt;fileName&gt;_response_0000x.txt : Contains http.http.android code and Content Type. Is readable (text file), UTF-8 encoded.
...
class HttpRequestResponseFileLogger implements HttpRequestResponseLogger {
     ...
     * @param requestWriter Responsible for writing http.http.android request to disk.
     * @param responseWriter Responsible for writing http.http.android response to disk.
     */
